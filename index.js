...
/*Task 1: counterMaker()
 ...
 counter1 contains a separate counter which exists inside a callback function
  
  2. Which of the two uses a closure? How can you tell?
  counter2 uses a closure because it's inner function calls the higher order function before being called.
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better? 
     I'll be honest, I don't really know. I can't think of a situation where the results would be different. 
*/
